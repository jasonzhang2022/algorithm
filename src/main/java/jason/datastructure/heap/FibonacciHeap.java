...
//why fibonacci heap: http://stackoverflow.com/questions/19508526/what-is-the-intuition-behind-the-fibonacci-heap-data-structure
//credit: http://keithschwarz.com/interesting/code/?dir=fibonacci-heap
//please note we have decreaseKey method, but not increaseKey method.
/***********************************************************************
 ...
 * @author Keith Schwarz (htiek@cs.stanford.edu)
 */
public final class FibonacciHeap<T> implements Heap<T>{
     ...
     * private.
     */
    public static final class Entry<T> extends Node<T> {
    ...
    public Entry<T> dequeueMin() {
        ...
        for (Entry<T> curr: toVisit) {
            ...
            while (true) {
                ...
                /*
                 * Comment by jason:
                 * So the degree is the number of the direct children, not the number of nodes in the whole tree.
                 */
